...
//        supportActionBar.setDisplayShowTitleEnabled(false);
    ...
    private void initBottomNavigationBar() {
        mBn_main.addItem(new BottomNavigationItem(R.drawable.bn_main_item_discover, mBnItemTitles[0]));
        mBn_main.addItem(new BottomNavigationItem(R.drawable.bn_main_item_discover, mBnItemTitles[1]));
        mBn_main.addItem(new BottomNavigationItem(R.drawable.bn_main_item_discover, mBnItemTitles[2]));
    ...
    public void onTabUnselected(int position) {
        getFragmentManager().beginTransaction().hide(FragmentFactory.getFragment(position)).commit();
    }
