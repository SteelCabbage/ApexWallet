...
public class DeleteNeoWalletPwdDialog extends DialogFragment implements View.OnClickListener, IFromKeystoreToNeoWalletCallback,
        IFromKeystoreToEthWalletCallback {

    private static final String TAG = DeleteNeoWalletPwdDialog.class.getSimpleName();
    ...
    public static DeleteNeoWalletPwdDialog newInstance() {
        return new DeleteNeoWalletPwdDialog();
    }
